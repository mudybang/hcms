...
namespace Master\Education\Controllers;

use App\Controllers\BaseController;
use App\Libraries\UserPerm;
use App\Libraries\PlatformDetect;
use Master\Education\Models\MEducation;
...
class Education extends BaseController{
    ...
    public function index(){
        if (auth()->loggedIn()) {
            ...
            $data['levels']=['Sekolah Menengah Pertama','Sekolah Menengah Atas','Pendidikan Tinggi'];
            $data['isMobile']=$this->request->getUserAgent()->isMobile();
            return view("\Master\Education\Views\dataview",$data);
        }else{
