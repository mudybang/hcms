...
<div data-options="region:'center'" title="" style="overflow:auto;padding:1px">
	<table id="dg" class="easyui-datagrid" style="width:<?=!@$isMobile?'auto':'1024px'?>;height:500px" 		
		...
		<thead>
			<tr>
				...
				<th field="tagname" width="150" sortable="true">Name</th>
				<th field="description">Description</th>
				<th field="manager_fullname">Manager</th>
		...
		<div class="search-box">
			<table>
				<tr>
					...
					<td>Parent</td>
					<td><?=easyui_department(['id'=>'sparent_id','name'=>'sparent_id','master'=>true])?></td>
					<td align="right">
	...
	<div id="dlg" class="easyui-dialog" style="width:<?=@$isMobile?'auto':'600px'?>;height:350px;padding:10px 20px" closed="true" buttons="#dlg-buttons">
		<form id="fm" method="POST" novalidate>
			...
			<div class="fitem">
				<label>Parent:</label>
				<?=easyui_department(['name'=>'parent_id','master'=>true])?>
			</div>
			<div class="fitem">
			...
			<div class="fitem">
				<label>Manager:</label>
				<?=easyui_numberbox(['name'=>'manager_id'])?>
			</div>
		</form>
	</div>
	<div id="dlg-buttons">
...
<script type="text/javascript">
	...
	function doSearch(){
		$('#dg').datagrid('load',{
			[csrfName]: csrfHash,
			sname: $('#sname').val(),
			sparent_id: $('#sparent_id').combobox('getValue')
		});
	}
