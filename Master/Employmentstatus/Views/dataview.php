...
<div data-options="region:'center'" title="" style="overflow:auto;padding:1px">
	<table id="dg" class="easyui-datagrid" style="width:<?=!@$isMobile?'auto':'1024px'?>;height:500px" 		
		...
		<thead>
			<tr>
				...
				<th field="label" width="150" sortable="true">Label</th>
				<th field="contract_type" width="150" sortable="true">Contract Type</th>
	...
	<div id="toolbar">
		...
		<div class="search-box">
			<table>
				<tr>
					<td>Label</td>
					<td><?=easyui_textbox(['id'=>'slabel','name'=>'slabel'])?></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td align="right">
	...
	<div id="dlg" class="easyui-dialog" style="width:<?=@$isMobile?'auto':'600px'?>;height:350px;padding:10px 20px" closed="true" buttons="#dlg-buttons">
		<form id="fm" method="POST" novalidate>
			...
			<div class="fitem">
				<label>Label:</label>
				<?=easyui_textbox(['name'=>'label','required'=>true])?>
			</div>
			<div class="fitem">
				<label>Contract Type:</label>
				<select name="contract_type" class="easyui-combobox" data-options="required:true" style="width:197px;">
					<option value=""></option>
					<?php
						foreach($contract_types as $contract_type){
							echo "<option value='".$contract_type."'>".$contract_type."</option>";
						}
					?>
				</select>
			</div>
