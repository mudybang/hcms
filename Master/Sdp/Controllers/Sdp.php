...
namespace Master\Sdp\Controllers;

use App\Controllers\BaseController;
use App\Libraries\UserPerm;
use App\Libraries\PlatformDetect;
use Master\Sdp\Models\MSdp;

class Sdp extends BaseController{
    protected $db;
    protected $perm;
    protected $table;
    protected $model;
    ...
    public function index(){
        if (auth()->loggedIn()) {
            ...
            $data['types']=['Skill','License','Skill & License'];
            $data['isMobile']=$this->request->getUserAgent()->isMobile();
            return view("\Master\Sdp\Views\dataview",$data);
        }else{
