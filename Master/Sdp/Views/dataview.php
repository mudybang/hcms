...
<div data-options="region:'center'" title="" style="overflow:auto;padding:1px">
	<table id="dg" class="easyui-datagrid" style="width:<?=!@$isMobile?'auto':'1024px'?>;height:500px" 		
		...
		<thead>
			<tr>
				...
				<th field="type" width="150" sortable="true">Type</th>
	...
	<div id="toolbar">
		...
		<div class="search-box">
			<table>
				<tr>
					<td>Title</td>
					<td><?=easyui_textbox(['id'=>'stitle','name'=>'stitle'])?></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td align="right">
	...
	<div id="dlg" class="easyui-dialog" style="width:<?=@$isMobile?'auto':'600px'?>;height:350px;padding:10px 20px" closed="true" buttons="#dlg-buttons">
		<form id="fm" method="POST" novalidate>
			...
			<div class="fitem">
				<label>Title:</label>
				<?=easyui_textbox(['name'=>'title','required'=>true])?>
			</div>
			<div class="fitem">
				<label>Type:</label>
				<select name="type" class="easyui-combobox" data-options="required:true" style="width:197px;">
					<option value=""></option>
					<?php
