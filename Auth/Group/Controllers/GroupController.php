...
namespace Auth\Group\Controllers;

use App\Controllers\BaseController;
use App\Libraries\UserPerm;
use App\Libraries\PlatformDetect;
use Auth\Group\Models\GroupModel;
...
class GroupController extends BaseController{
    ...
    public function index(){
        if (auth()->loggedIn()) {
            ...
            return view("\Auth\Group\Views\dataview",$data);
        }else{
    ...
    public function get_data(){
        ...
        $sort = isset($_POST['sort']) ? strval($_POST['sort']) : 'g.id';
