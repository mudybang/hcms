...
<div data-options="region:'center'" title="" style="overflow:auto;padding:1px">
	<table id="dg" class="easyui-datagrid" style="width:<?=!@$isMobile?'auto':'1024px'?>;height:500px" 		
		data-options="idField:'id', toolbar:'#toolbar', url:'<?=current_url()?>/get_data', queryParams:{<?= csrf_token(); ?>:'<?= csrf_hash(); ?>'},
            pagination:true, rowcard_numbers:true, fitColumns:true, singleSelect:true">
		<thead>
			<tr>
				...
				<th field="insurance_name">Insurance Name</th>
				<th field="card_number">Card Number</th>
				<th field="register_date">Register Date</th>
				<th field="expired_date">Expired Date</th>
				<th field="given_date">Given Date</th>
	...
	<div id="dlg" class="easyui-dialog" style="width:<?=@$isMobile?'auto':'700px'?>;height:600px;padding:10px 20px" closed="true" buttons="#dlg-buttons">
		<form id="fm" method="POST" enctype="multipart/form-data" autocomplete="off" novalidate>
			...
			<div class="fitem">
				...
				<?=easyui_textbox(array('name'=>'insurance_name','required'=>true))?>
			</div>
			<div class="fitem">
				<label>Number:</label>
				<?=easyui_numberbox(array('name'=>'card_number','required'=>true,'autocomplete'=>'off'))?>
			</div>
			<div class="fitem">
			...
			<div class="fitem">
				...
				<?=easyui_datebox(array('name'=>'expired_date'))?>
			</div>
			<hr/>
			<table>
				<?php
			...
			<div class="fitem">
				...
				<?=easyui_datebox(array('name'=>'given_date'))?>
			</div>
			<div class="fitem">
				<label>Receipn:</label>
