	...
	<table id="dg" class="easyui-datagrid" style="width:<?=!@$isMobile?'auto':'1024px'?>;height:500px" 		
		...
		<thead>
			<tr>
				...
				<th field="rp_value_" align="right">Value</th>
				<th field="receive_date">Receive@</th>
				<th field="installment">Ins.</th>
				<th field="note">Note</th>
				<th field="approval">Status</th>
		...
		<div class="search-box">
			<table>
				...
				<tr>
					...
					<td>Receive@</td><td><?=easyui_datebox(array('id'=>'fdate','name'=>'fdate'))?> to <?=easyui_datebox(array('id'=>'ldate','name'=>'ldate'))?></td>
					<td>Status</td><td><?=easyui_combobox_option(array('id'=>'sapproval','name'=>'sapproval'))?></td>
					<td colspan=2>
	...
	<div id="dlg" class="easyui-dialog" style="width:<?=@$isMobile?'auto':'600px'?>;height:440px;padding:10px 20px" closed="true" buttons="#dlg-buttons">
		<form id="fm" method="POST" enctype="multipart/form-data" novalidate>
			...
			<div class="fitem">
				...
				<?=easyui_installment(array('name'=>'installment'))?>
			</div>
			<div class="fitem">
				<label>Note:</label>
			...
			<div class="fitem">
				...
				<?=easyui_combobox_option(array('name'=>'approval','label'=>'APPROVAL_STATUS','required'=>true))?>
			</div>
			<div class="fitem">
				<label>Receive Date:</label>
				<?=easyui_datebox(array('name'=>'receive_date'))?>
			</div>
			<div class="fitem">
				<label>Receipn:</label>
...
<script type="text/javascript">
	...
	function doSearch(){
		$('#dg').datagrid('load',{
			...
			stitle: $('#stitle').val(),
			sapproval: $('#sapproval').combobox('getValue'),
